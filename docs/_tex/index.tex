...
\hypersetup{
  pdftitle={National Park Insights: An ETL Pipeline for Alerts, Activities, and Trip Planning Using Prefect},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{National Park Insights: An ETL Pipeline for Alerts, Activities,
and Trip Planning Using Prefect}
\usepackage{etoolbox}
\makeatletter
...
{\centering \includegraphics{assets/nps-scraper-flow.png}
...
{\centering \includegraphics{assets/nps-report-flow.png}
...
{\centering \includegraphics{assets/nps-scraper-deployment.png}
